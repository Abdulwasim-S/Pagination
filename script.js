...
function clicking(v){
    ...
    if(v===10){
        ...
        document.getElementById("last").style.width="0px";
    }
    else{
        document.getElementById("next").style.visibility="visible";
        document.getElementById("next").style.width="100%";
        document.getElementById("last").style.visibility="visible";
        document.getElementById("last").style.width="100%";
    }
    var k=(v-1)*10;
...
function setvalues(n,result){
    for(var i=n;i<n+10;i++){
        ...
        if(i%10===6){
            document.getElementById("ID7").innerHTML=result[i].id;
            document.getElementById("NAME7").innerHTML=result[i].name;
            document.getElementById("EMAIL7").innerHTML=result[i].email.toLowerCase();
        }
        if(i%10===7){
            document.getElementById("ID8").innerHTML=result[i].id;
            document.getElementById("NAME8").innerHTML=result[i].name;
            document.getElementById("EMAIL8").innerHTML=result[i].email.toLowerCase();
        }
        if(i%10===8){
            document.getElementById("ID9").innerHTML=result[i].id;
            document.getElementById("NAME9").innerHTML=result[i].name;
            document.getElementById("EMAIL9").innerHTML=result[i].email.toLowerCase();
        }
        if(i%10===9){
            document.getElementById("ID0").innerHTML=result[i].id;
            document.getElementById("NAME0").innerHTML=result[i].name;
            document.getElementById("EMAIL0").innerHTML=result[i].email.toLowerCase();
        }
    }
}
